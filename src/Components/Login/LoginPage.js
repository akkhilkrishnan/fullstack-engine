                    ...
                    <div className="user-content">
                        {signupFlag ? <>
                            ...
                            <div style={{ display: 'flex', height: '40px', justifyContent: 'center' }}>
                                <span style={{ fontSize: '14px' }}>Not a member?<span className="link" onClick={() => setSignupFlag(!signupFlag)}> Sign up now</span></span>
                            </div>

                        </>
                            :
                            <>
                            <div className="login-header"> <p className="title">Create Account</p></div>
